    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="register_form.php">Registrarse</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link active" href="logIn_form.php">Iniciar Sesión</a>
                </li>
            </ul>
        </div>
    </div>
...
<section id="hero" class="min-vh-100 d-flex align-items-center text-center" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../../../../assets/images/vet-background.jpg') center/cover;">
    ...
    <div class="form-overlay2 position-absolute top-50 start-50 translate-middle">
        <div class="p-4 rounded">
            ...
            <?php endif;  ?>
            <form action="../../../backOffice/validator/login_validator.php" method="POST">
                <div class="mb-3 mt-3">
                    <label class="fw-bold text-white ">Usuario <span class="text-danger">*</span></label>
                    <input id="userName" name="userName" type="text" class="form-control" placeholder="Nombre" autocomplete="off" required>
                </div>
                <div class="mb-3">
