...
<section id="hero" class="min-vh-100 d-flex align-items-center text-center" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../../assets/images/vet-background.jpg') center/cover;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="text-uppercase text-white fw-semibold display-1" data-aos="fade-down">
                    Bienvenido <?php echo "<strong style='color:#4CAF50'>" .
                        (isset($_SESSION["userName"]) ? $_SESSION["userName"] : '') . "</strong>"; ?> a VetCare</h1>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-member bg-white p-4 rounded shadow">
                    <img src="../../assets/images/doctor1.jpg" alt="Dr. Carlos Rodríguez" class="img-fluid rounded-circle mb-4 w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-member bg-white p-4 rounded shadow">
                    <img src="../../assets/images/doctor2.jpg" alt="Dra. Ana Martínez" class="img-fluid rounded-circle mb-4 w-100">
                    <div class="text-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-member bg-white p-4 rounded shadow">
                    <img src="../../assets/images/doctor3.jpg" alt="Dr. Miguel Sánchez" class="img-fluid rounded-circle mb-4 w-100">
                    <div class="text-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-member bg-white p-4 rounded shadow">
                    <img src="../../assets/images/doctor4.jpg" alt="Dra. Laura González" class="img-fluid rounded-circle mb-4 w-100">
                    <div class="text-center">
